        ...
        <div class="container">
            <div class="section-title mb45 headline text-center">
                @if(Session::has('success'))
                    ...
                    <h3>¡Pago realizado correctamente! ¡Muchas gracias!</h3>
                    <h4><a href="{{route('admin.dashboard')}}">{{-- @lang('labels.frontend.cart.see_more_courses') --}}
                    Encontrarás el curso en tu panel de usuario. Haz clic aquí.</a></h4>
                @endif
