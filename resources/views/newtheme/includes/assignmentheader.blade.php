...
<div class="col-sm-4" style="font-weight: bold">
 ...
 --}}
            ...
            <div class="dropdown-menu dropdown-menu-right" style="padding: 6px;border-radius: 20px;">
                ...
                <div class="unreadMessages">
                    ...
                    @foreach(auth()->user()->unreadNotifications as $notification)
                       ...
                       <ul>
                           <li>
                       <a style="color: black;text-decoration: none;font-weight: 600;font-family: system-ui;font-size: 15px;" href="{{url('markread')}}/{{$notification->id}}/{{auth()->user()->id}}/{{$notification->data['history_id'] ?? 0}}/{{$notification->data['chapter_id'] ?? 0}}">
                       ...
                       <a style="font-size: 15px;cursor: pointer;color: black;font-weight: 500;" onclick="openNewNav()">
                         &nbsp; &nbsp; {{$notification->data['comment']}} 
                       <br> 
                       </a>
                           </li>
                       ...
                       @endif
                            ...
                            <div id="NewSideBarQuestions" class="Newsidenav">
                                ...
                                <div class="row" style="margin: 2%;">
                                    <div class="closediv">
                                  <a href="javascript:void(0)" onclick="closeNewNav()">&times;</a>
                            ...
                            <div class="noti-body">    
                                    <!-- free zoom class notification -->
                                        ...
                                        @if(auth()->user())
                                        @isset($ExtraAssignment1All)
                                        @foreach($ExtraAssignment1All as $key => $Extra)
                            ...
                            @endif
                                ...
                                <!-- <div class="row" style="margin-left: 10px;">
                                    ...
                                    <ul>
                                    @isset($ExtraAssignment1)
                                        @foreach($ExtraAssignment1 as $key => $Extra)
