...
<div class="stm_lms_user_info_top">
	...
	<div class="stm_lms_user_bio">
        ...
        <h3>1.  Definición e Interpretación</h3>
        ...
        <p>“Usuario” / “Usuarios”: significa cualquier tercero que acceda al Sitio Web y no sea empleado por EL PRESTADOR DEL SERVICIO y que actúe utilizando los recursos y servicios ofrecidos.</p>


        <h3 class="">2.  Restricciones de edad</h3>
        ...
        <h3 class="">3.  Clientes empresariales</h3>
        ...
        <h3 class="">4.  Propiedad intelectual</h3>
        <p>4.1 Sujeto a las excepciones de la Cláusula 5 de estos Términos y Condiciones, todo el Contenido incluido en el Sitio Web, a menos que sea cargado por Usuarios, incluyendo, pero no limitado a, texto, gráficos, logotipos, iconos, imágenes, clips de sonido, videoclips, datos Compilaciones, diseño de página, código subyacente y software es propiedad de EL PRESTADOR DEL SERVICIO, de nuestros afiliados u otros terceros relevantes. Al continuar utilizando el Sitio Web, usted reconoce que dicho material está protegido por las leyes de propiedad intelectual y otras leyes aplicables a España y la Comunidad Europea y a las leyes Internacionales.</p>
        ...
        <h3 class="">5.  Propiedad intelectual de terceros.</h3>
...
<h3 class="">11. Terminación y cancelación de cuentas</h3>
...
<h3 class="">12. Servicios, precios y disponibilidad y clases por videoconferencia</h3>
...
<h3 class="">13. Órdenes y Prestación de Servicios</h3>
    ...
    <p>13.8 <b>EL PRESTADOR DEL SERVICIO</b> proporcionará asistencia técnica a través de nuestro foro de soporte en línea y / o teléfono. EL PRESTADOR DEL SERVICIO hará todo lo posible para responder a las solicitudes de asistencia dentro de los 30 minutos durante las horas de trabajo europeas (de 9:00 a 20:00 horas), pero no garantizamos un tiempo de respuesta en particular.</p>

<h3 class="">14. Cancelación de Órdenes y Servicios</h3>

<p>Queremos que esté completamente satisfecho con los productos o servicios que solicita de EL PRESTADOR DEL SERVICIO. Si necesita hablar con nosotros sobre su pedido, póngase en contacto con el servicio de atención al cliente en el email info@ray-bolivar-sosa.es</p>
...
<h3 class="">16. Cómo utilizamos su información personal</h3>
<p>
    <ul>
...
<h3 class="">17. Descargo de responsabilidad</h3>
<p>
    <ul>
...
<h3 class="">18. Cambios en las Instalaciones y en estos Términos y Condiciones</h3>
...
<h3 class="">19. Disponibilidad del sitio web</h3>
<p>
    <ul>
        <li>19.1 El Sitio Web se proporciona “tal cual” y en la base “según sea posible”. EL PRESTADOR DEL SERVICIO utiliza las mejores prácticas de la industria para proporcionar un alto tiempo de actividad, incluida una arquitectura tolerante a fallos alojada en servidores en la nube. No garantizamos que el Sitio Web o las Instalaciones estén libres de defectos y / o fallas y no proporcionamos ningún tipo de reembolso por interrupciones. No ofrecemos garantías (expresas o implícitas) de idoneidad para un propósito en particular, exactitud de información, compatibilidad y calidad satisfactoria.</li>
...
<h3 class="">20. Limitación de responsabilidad</h3>
<p><ul>
    ...
    <li>20.2 Nada de lo contenido en estos Términos y Condiciones excluye o restringe la responsabilidad de EL PRESTADOR DEL SERVICIO por muerte o lesiones personales resultantes de cualquier negligencia o fraude por parte de EL PRESTADOR DEL SERVICIO.</li>
    <li>20.3 Nada de lo contenido en estos Términos y Condiciones excluye o restringe la responsabilidad de EL PRESTADOR DEL SERVICIO por cualquier pérdida o daño directo o indirecto que surja de la provisión incorrecta de Servicios o de la dependencia de información incorrecta incluida en el Sitio Web.</li>
...
<h3 class="">22. Términos y condiciones anteriores</h3>
...
<h3 class="">23. Derechos de terceros</h3>
