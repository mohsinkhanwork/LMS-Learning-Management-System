        ...
        <div class="card-header">
            ...
            <div>
             <a href="{{url('moveancient')}}" class="btn btn-default" style="background-color: #a1a1a1; color: white;width: 128px">Ancient Texts</a>
              ...
              <div class="float-right" style="margin-left: auto; margin-right:0">
        ...
        <div class="card-body table-responsive">
            ...
            <table id="myTable"
                ...
                <tbody>
                    ...
                    {{-- <div style="display: flex;">
                       <div>
                           <a href="#" class="btn btn-default" style="background-color: #a02110; color: white; width: 122px">Answered</a>
                       </div>
                       &nbsp;
                       <div>
