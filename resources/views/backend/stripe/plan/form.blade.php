...
<div class="row">
    ...
    <div class="col-12 col-lg-6 form-group">
        ...
        {!! Form::text('currency', old('currency'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.stripe.plan.fields.currency'), 'required' => true, 'readonly' => $plan->id? false: false]) !!}
