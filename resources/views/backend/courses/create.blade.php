...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">        
            <div class="col-10 form-group">
                Select General Course Levels
                <select name="level" class="form-control">
                <option>Course level for General Category</option>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    ...
                    {!! Form::file('course_image',  ['class' => 'form-control', 'accept' => 'image/jpeg,image/gif,image/png', 'required' => true]) !!}
