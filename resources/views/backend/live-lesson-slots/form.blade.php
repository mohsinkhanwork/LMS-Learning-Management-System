...
<div class="row">
    <div class="col-12 col-lg-6 form-group">
        ...
        {!! Form::datetimeLocal('start_at', $liveLessonSlot->id?$liveLessonSlot->start_at->format('Y-m-d\TH:i'):old('start_at'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.live_lesson_slots.fields.date_of_slot'),'required' => true, 'min' => $liveLessonSlot->id ? $liveLessonSlot->start_at->format('Y-m-d'): '']) !!}
    </div>
    <div class="col-12 col-lg-6 form-group">
        {!! Form::label('duration', trans('labels.backend.live_lesson_slots.fields.duration').'*', ['class' => 'control-label']) !!}
        {!! Form::number('duration', old('duration'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.live_lesson_slots.fields.duration'), 'required' => true, 'min' => 5]) !!}
    </div>
</div>
<div class="row">
    <div class="col-12 col-lg-6 form-group">
    ...
    <div class="col-12 col-lg-6 form-group">
        ...
        {!! Form::number('student_limit', old('student_limit'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.live_lesson_slots.fields.student_limit'), 'required' => true,  'min' => 1, 'max' => 150]) !!}
    </div>
</div>
