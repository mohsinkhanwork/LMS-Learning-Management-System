<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="{{ url('/') }}">
        <img class="navbar-brand-full" src="{{ asset('newtheme/images/Copy-of-Ray-6.png')}}"  height="40" alt="Square Logo">
        <img class="navbar-brand-minimized" src="{{ asset('newtheme/images/Copy-of-Ray-6.png')}}" height="45" alt="Square Logo">
    </a>
