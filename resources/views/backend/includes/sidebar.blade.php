...
<div class="sidebar">
    ...
    <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/courses*','user/lessons*','user/tests*','user/questions*','user/live-lessons*','user/live-lesson-slots*']), 'open') }}">
                <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/*')) }}"
                       href="#">
                        <i class="nav-icon icon-envelope-letter"></i> Leads / User
                    ...
                    <ul class="nav-dropdown-items">
                            ...
                            @can('question_access')
                                 <li class="nav-item ">
                                    <a class="nav-link {{ $request->segment(2) == 'contact-requests' ? 'active' : '' }}"
                                       href="{{ route('firstRegister.index') }}">
                                        <span class="title">First Registered Users</span>
                                    </a>
                                </li>
                                @endcan
         ...
         @endif
            ...
            @if((!$logged_in_user->hasRole('student')) && ($logged_in_user->hasRole('teacher') || $logged_in_user->isAdmin() || $logged_in_user->hasAnyPermission(['course_access','lesson_access','test_access','question_access','bundle_access'])))
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/courses*','user/lessons*','user/tests*','user/questions*','user/live-lessons*','user/live-lesson-slots*']), 'open') }}">
                    <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/*')) }}"
                       href="#">
                        <i class="nav-icon icon-puzzle"></i>Affiliate
                    </a>
                    <ul class="nav-dropdown-items">
                        @can('question_access')
                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'paid-affiliate' ? 'active' : '' }}"
                                   href="{{route('paid-affiliate.index')}}">
                                    <span class="title">Referrer Person</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/courses*','user/lessons*','user/tests*','user/questions*','user/live-lessons*','user/live-lesson-slots*']), 'open') }}">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @can('lesson_access')
                            <li class="nav-item ">
                                <a class="nav-link {{ $request->segment(2) == 'topic' ? 'active' : '' }}"
               ...
               <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/courses*','user/lessons*','user/tests*','user/questions*','user/live-lessons*','user/live-lesson-slots*']), 'open') }}">
                    <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/*')) }}"
                       href="#">
                        <i class="nav-icon icon-puzzle"></i>Extra Assignmnt
                    </a>
                    <ul class="nav-dropdown-items">
                        @can('question_access')
                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'extra-assignment' ? 'active' : '' }}"
                                   href="{{route('extra-assignment.index')}}">
                                    <span class="title">Extra-Assignment</span>
                                </a>
                            </li>
                        @endcan
                        @can('question_access')
                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'extra-assignment' ? 'active' : '' }}"
                                   href="{{route('extra-assignment.create')}}">
                                    <span class="title">Add Extra-Assignment</span>
                                </a>
                            </li>
                        @endcan
                        @can('question_access')
                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'get-extraassignment-data' ? 'active' : '' }}"
                                   href="{{route('get-extraassignment-data')}}">
                                    <span class="title">UnApprove Extra-Assignment</span>
                                </a>
                            </li>
                        @endcan
                        @can('question_access')
                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'get-extraassignment' ? 'active' : '' }}"
                                   href="{{url('get-extraassignment')}}">
                                    <span class="title">Approve Extra-Assignment</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
                ...
                @can('question_access')
                    <li class="nav-item ">
                        <a class="nav-link {{ $request->segment(1) == 'guidebook' ? 'active' : '' }}"
                           href="{{ route('guidebook.index') }}">
                            <i class="nav-icon icon-layers"></i>
                            <span class="title">GuideBook</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('question_access')
                    <li class="nav-item ">
                        <a class="nav-link {{ $request->segment(1) == 'skill' ? 'active' : '' }}"
