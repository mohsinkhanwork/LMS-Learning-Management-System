...
@section('content')
    ...
    @endif
        <div class="card-header">
            <h3 class="page-title mb-0 float-left">{{$Assignment->user->first_name}} {{$Assignment->user->last_name}} Extra Assignment</h3>
            <div class="float-right">
                <a href="{{ url('get-extraassignment-data') }}"
        ...
        <div class="card-body">
            ...
            @else
            <form action="{{url('updateextraassign')}}" method="post">
            @csrf
