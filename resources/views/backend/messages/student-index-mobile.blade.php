...
@section('content')
    ...
    <div class="card message-box newmob">
    ...
    border-radius: 20px;">
                    ...
                    <a href="{{route('admin.student_messages')}}" class="d-lg-none text-decoration-none threads d-md-none">
                        ...
                        <div class="headind_srch">
                            <div class="recent_heading btn-sm btn btn-dark">
                                <a class="text-decoration-none compose" href="#">
                                    <h5 class="text-white mb-0" style="color: black !important;"><i class="icon-plus"></i> COMPOSE </h5>
                                </a>
                            ...
                            @if($threads->count() > 0)
                                @foreach($threads as $item)
                                    @if($item->latestMessage)
                                        <a  href="{{route('admin.student_messages').'?thread='.$item->id}}" class="@if($item->userUnreadMessagesCount(auth()->user()->id)) unread
                                            @endif">
                        ...
                        <div class="headind_srch bg-dark">
                            <div class="chat_people header row">
                                <div class="col-12 col-lg-3">
                                    <p class="font-weight-bold text-white mb-0" style="line-height: 21px">@lang('labels.backend.messages.select_recipients'):</p>
                                </div>
