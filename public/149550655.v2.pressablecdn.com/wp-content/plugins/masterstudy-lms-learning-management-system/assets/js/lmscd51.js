...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('[data-lms-modal]').on('click', function (e) {
      ...
      if(modal == "subscription_checkout" && jQuery('.modal.fade.stm-lms-modal-subscription-checkout').length > 0){
        jQuery('.modal.fade.stm-lms-modal-subscription-checkout').remove();
      }


      if($(this).hasAttr("data-course-price")){

        var item_id = $(this).data('course-id');
      ...
      if (!$(modal_target).length) {
        ...
        var params = $(this).attr('data-lms-params');
          ...
          if(modal == "checkout" && jQuery('.modal.fade.stm-lms-modal-checkout').length > 0){
            jQuery('.modal.fade.stm-lms-modal-checkout').remove();
          }
