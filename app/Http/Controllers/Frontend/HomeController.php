...
class HomeController extends Controller
{
    ...
    //   //  dd(__DIR__);
        ...
        // dd($Avanzado_course_level);
        
        $courses = Course::withoutGlobalScope('filter')->canDisableCourse()->where('published', 1)->orderBy('id', 'desc')->with('category')->take(8)->get();

        $totalcourses = Course::withoutGlobalScope('filter')->canDisableCourse()->where('published', 1)->orderBy('id', 'desc')->get();

        $freecourses = Course::withoutGlobalScope('filter')->canDisableCourse()->where(['published'=> 1,'free'=>1])->orderBy('id', 'desc')->get();
        
        

        $freecourses = Course::withoutGlobalScope('filter')->canDisableCourse()->where(['published'=> 1,'free'=>1])->orderBy('id', 'desc')->take(2)->get();
        ...
        // $ExtraAssignment = Extraassignment::get();
        $ExtraAssignment = Extraassignment::with('users')->orderBy('id','desc')->get();
        // $ExtraAssignment = Extraassignment::users()->get();
        $student_courses = Course::with('students')->get();
        ...
        return view($this->path . '.index-' . config('theme_layout'), compact('popular_courses', 'initial_course_level', 'Intermedio_course_level', 'Avanzado_course_level' , 'lesson' ,'purchased_cours' ,'noti_id', 'ExtraAssignment', 'user', 'featured_courses', 'sponsors', 'total_students', 'total_courses', 'total_teachers', 'testimonials', 'courses', 'news', 'freecourses', 'trending_courses', 'teachers', 'faqs', 'course_categories', 'totalcourses', 'reasons', 'sections','categories', 'pildora_categories'));

        // dd(auth()->user()->id);
        // dd($ExtraAssignment);
        // dd($courses);
        return view($this->path . '.index-' . config('theme_layout'), compact('popular_courses', 'lesson', 
                    'purchased_cours' ,'noti_id', 'ExtraAssignment', 'user', 'featured_courses', 'sponsors', 
                    'total_students', 'total_courses', 'total_teachers', 'testimonials', 'courses', 'news', 
                    'freecourses', 'trending_courses', 'teachers', 'faqs', 'course_categories', 'totalcourses', 
                    'reasons', 'sections','categories', 'student_courses'));
        // $purchased_cours = '';
        // $id = array();
        // $noti_id = array();
        // $ExtraAssignment = array();
        ...
        // }
        // dd($lesson);
        // return view($this->path . '.index-' . config('theme_layout'), compact('popular_courses', 'lesson' ,'purchased_cours' ,'noti_id', 'ExtraAssignment', 'user', 'featured_courses', 'sponsors', 'total_students', 'total_courses', 'total_teachers', 'testimonials', 'courses', 'news', 'freecourses', 'trending_courses', 'teachers', 'faqs', 'course_categories', 'totalcourses', 'reasons', 'sections','categories'));
        // return view($this->path . '.index-' . config('theme_layout'), compact('popular_courses', 'lesson', 'ExtraAssignment', 'user', 'featured_courses', 'sponsors', 'total_students', 'total_courses', 'total_teachers', 'testimonials', 'courses', 'news', 'freecourses', 'trending_courses', 'teachers', 'faqs', 'course_categories', 'totalcourses', 'reasons', 'sections','categories'));
    ...
    public function searchCourse(Request $request)
    {
        ...
        return view($this->path . '.courses.index', compact('courses', 'initial_course_level', 'Intermedio_course_level', 'Avanzado_course_level'  ,'pildora_categories' , 'q', 'recent_news','featured_courses', 'categories'));
    }
    ...
    public function signup(){
        ...
        return view('frontend.layouts.modals.signup',compact('categories', 'pildora_categories' , 'initial_course_level', 'Intermedio_course_level', 'Avanzado_course_level'));

        return view('frontend.layouts.modals.signup',compact('categories', 'student_courses', 'purchased_cours',
                    'ExtraAssignment', 'lesson', 'noti_id', 'courses'));
