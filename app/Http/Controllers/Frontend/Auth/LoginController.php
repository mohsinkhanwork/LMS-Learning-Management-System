        ...
        return response(['success'=>false,'errors' => $validator->errors()]);
            ...
            if($authSuccess) {
                ...
                if(auth()->user()->active > 0){
                    ...
                    }elseif(is_null(auth()->user()->last_login_at)) {
                    ...
                    return  redirect('/signup')->with('Activefailed', 'Login failed. Account is not active');
                        // response([
                        //     'success' => false,
                        //     'message' => 'Login failed. Account is not active'
                        // ], Response::HTTP_FORBIDDEN);
                ...
                return  redirect('/signup')->with('failed', 'Login failed. Account not found');
                    // response([
                    //     'success' => false,
                    //     'message' => 'Login failed. Account not found'
                    // ], Response::HTTP_FORBIDDEN);
