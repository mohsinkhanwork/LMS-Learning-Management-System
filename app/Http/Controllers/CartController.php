...
class CartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view($this->path . '.cart.checkout', compact('courses', 'categories', 'bundles', 'total', 'taxData'));
    }
...
//        return view($this->path . '.cart.checkout', compact('courses', 'total', 'taxData'));
    ...
    public function stripePayment(Request $request)
    {
        ...
        $gateway->setApiKey('sk_live_4n0jurauKjSAjgdI76CTmLPT');
    ...
    public function status(){
        $categories = Category::where('status', '=', 1)->get();
        return view('frontend.cart.status',compact('categories'));
    }
    public function getNow(Request $request)
    {
        ...
        Session::flash('success', '¡Felicidades! Tienes este curso.');
        return back();
