...
class CertificateController extends Controller
{
    ...
    public function getCertificates()
    {
        ...
        $user = auth()->user();
        return view('backend.certificates.index', compact('certificates', 'user'));
    }
    ...
    public function generateCertificate(Request $request)
    {
        ...
        if (($course != null) && ($course->progress() == 100)) {
            ...
            return back()->withFlashSuccess('Felicitaciones, has terminado el curso. Encontrarás el certificado en tu cuenta, ve al apartado certificados.');
        }
        return abort(404);
    }
