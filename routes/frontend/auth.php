    ...
    */
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        if (config('access.registration')) {
            ...
            Route::post('register_lead', [RegisterController::class, 'register_lead'])->name('register_lead');

            Route::post('register_one', [RegisterController::class, 'register_one'])->name('register_one');
        }
