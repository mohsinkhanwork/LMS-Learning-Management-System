...
Route::post('/invitation',[DashboardController::class,'invitation'])->name('invitation'); 

Route::get('/student_dashboard',[DashboardController::class,'stu_dashboard'])->name('student_dashboard');
Route::get('/Student_courses', [DashboardController::class, 'student_courses'])->name('Student_courses');
Route::get('/Student_affliate', [DashboardController::class, 'Student_affliate'])->name('Student_affliate');

Route::post('/search-course',[DashboardController::class,'search_course'])->name('search-course');

Route::get('/markread/{id}/{user_id}',[DashboardController::class,'markread'])->name('markeard');
...
Route::group(['middleware' => ['auth', 'password_expires']], function () {
    Route::get('student_account', [AccountController::class, 'student_index'])->name('student_account');
    Route::patch('student_account/{email?}', [UserPasswordController::class, 'student_update'])->name('student_account.post');
    Route::patch('student_profile/update', [ProfileController::class, 'student_update'])->name('student_profile.update');
});
...
Route::get('student/messages', ['uses' => 'MessagesController@student_index', 'as' => 'student_messages']);
Route::post('student/messages/unread', ['uses' => 'MessagesController@student_getUnreadMessages', 'as' => 'student_messages.unread']);
Route::post('student/messages/send', ['uses' => 'MessagesController@student_send', 'as' => 'student_messages.send']);
Route::post('student/messages/reply', ['uses' => 'MessagesController@student_reply', 'as' => 'student_messages.reply']);
